...
> Uma CLI leve e nativa para terminal, projetada para manipulação do sistema de arquivos, automação de tarefas e integração direta com praticamente qualquer modelo de Inteligência Artificial.
...
- **Suporte a SOs:** Atualmente focado em Linux (ainda não possui versão para Windows).
...
Atualmente a cli funciona somente no linux.
